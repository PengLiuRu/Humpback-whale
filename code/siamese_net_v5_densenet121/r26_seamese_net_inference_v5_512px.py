...
from siamese_net_v5_densenet121.r25_seamese_net_train_v5_finetune_512px import get_tagged_data, get_boxes, get_kfold_split_weimin
...
def get_trained_model(fold):
    ...
    best_models = glob.glob(dir_path + 'ft_v5_512px_finetune_{}_*.model'.format(fold))
    best_score = -1.0
    best_weights = ''
...
'''
Full matrix
Fold 0: THR: 0.99 Overall MAP5: 0.966244
Fold 1: THR: 0.99 Overall MAP5: 0.966209
Fold 2: THR: 0.99 Overall MAP5: 0.958361
Fold 3: THR: 0.99 Overall MAP5: 0.966047
'''